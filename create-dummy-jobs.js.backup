...
async function createDummyJobs() {
  ...
  try {
    ...
    // Check if companies table exists, if not create some basic companies
    ...
    if (companyCheck.rows[0].exists) {
      // Get existing company IDs or create some basic ones
      const existingCompanies = await client.query('SELECT id FROM companies LIMIT 5');
      
      if (existingCompanies.rows.length === 0) {
        // Create some basic companies
        const companies = [
          { name: 'Dropbox', website: 'https://dropbox.com', logo: 'https://cdn.worldvectorlogo.com/logos/dropbox-1.svg' },
          { name: 'Netflix', website: 'https://netflix.com', logo: 'https://cdn.worldvectorlogo.com/logos/netflix-3.svg' },
          { name: 'Zillow', website: 'https://zillow.com', logo: 'https://cdn.worldvectorlogo.com/logos/zillow-1.svg' },
          { name: 'Colorado Department of Transportation', website: 'https://cdot.gov', logo: null },
          { name: 'Reddit', website: 'https://reddit.com', logo: 'https://cdn.worldvectorlogo.com/logos/reddit-1.svg' }
        ];
      ...
      // If companies table doesn't exist, we'll use NULL for company_id
    ...
    // Define 10 dummy jobs (6 from real companies, 4 from CDOT)
    const jobs = [
      // Real company jobs (6)
      {
        title: 'Senior Software Engineer - Remote',
        company_id: companyIds[0], // Dropbox
        ...
        application_url: 'https://dropbox.com/careers/senior-software-engineer',
        is_active: true,
        category_id: categoryIds[0] || null
      },
      {
        title: 'Content Operations Specialist',
        company_id: companyIds[1], // Netflix
        ...
        application_url: 'https://netflix.com/careers/content-operations',
        is_active: true,
        category_id: categoryIds[0] || null
      },
      {
        title: 'Real Estate Data Analyst',
        company_id: companyIds[2], // Zillow
        ...
        application_url: 'https://zillow.com/careers/data-analyst',
        is_active: true,
        category_id: categoryIds[0] || null
      },
      {
        title: 'Community Manager',
        company_id: companyIds[4], // Reddit
        ...
        application_url: 'https://reddit.com/careers/community-manager',
        is_active: true,
      ...
      },
      {
        ...
        application_url: 'https://dropbox.com/careers/customer-success',
        is_active: true,
        category_id: categoryIds[1] || null
      },
      {
        ...
        application_url: 'https://netflix.com/careers/ux-designer',
        is_active: true,
        category_id: categoryIds[0] || null
      },
      ...
      // CDOT jobs (4)
      {
        ...
        application_url: 'https://cdot.gov/careers/transportation-analyst',
        is_active: true,
      ...
      },
      {
        ...
        application_url: 'https://cdot.gov/careers/it-systems-admin',
        is_active: true,
        category_id: categoryIds[0] || null
      },
      {
        ...
        application_url: 'https://cdot.gov/careers/environmental-specialist',
        is_active: true,
        category_id: categoryIds[2] || null
      },
      {
        ...
        application_url: 'https://cdot.gov/careers/traffic-data-coordinator',
        is_active: true,
        category_id: categoryIds[2] || null
      }
    ];
    ...
    for (let i = 0; i < jobs.length; i++) {
      ...
      `, [
        ...
        job.is_active, job.category_id, 1 // created_by
      ]);
